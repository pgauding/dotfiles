...
alias df='df -H'
alias bashedit='emacsclient ~/.bash_aliases'
alias bashreload='. ~/.bash_profile'
alias eject2='diskutil eject /dev/disk2'
alias sleepnow='pmset sleepnow'
alias night='pmset sleepnow'
alias .emacs='emacsclient ~/dotfiles/.emacs'
alias oepn='open'
alias cadt='cat'
...
alias tmptxt='emacsclient ~/tmp/tmp.txt'
alias tmpr='emacsclient ~/tmp/tmp.R'
...
alias game='emacsclient -batch -l dunnet'
...
alias TODO='emacsclient ~/Library/Mobile\ Documents/iCloud~com~appsonthemove~beorg/Documents/org/TODO.org'
